...
[Ansible](#){:.btn.btn-outline-success.btn-sm}
[Jenkins](#){:.btn.btn-outline-primary.btn-sm}
[AWS](#){:.btn.btn-outline-success.btn-sm}
[Telegraf](#){:.btn.btn-outline-success.btn-sm}
[Redis](#){:.btn.btn-outline-info.btn-sm}
[Shell Script](#){:.btn.btn-outline-info.btn-sm}
[Terraform](#){:.btn.btn-outline-success.btn-sm}
[Kubernetes](#){:.btn.btn-outline-success.btn-sm}
[helm](#){:.btn.btn-outline-warning.btn-sm}
[Argocd](#){:.btn.btn-outline-success.btn-sm}
[Karpenter](#){:.btn.btn-outline-success.btn-sm}
[ELK Stack](#){:.btn.btn-outline-success.btn-sm}
[Packer](#){:.btn.btn-outline-success.btn-sm}
[Nexus](#){:.btn.btn-outline-warning.btn-sm}
[Nginx](#){:.btn.btn-outline-info.btn-sm}
[Groovy](#){:.btn.btn-outline-warning.btn-sm}
[Kafka](#){:.btn.btn-outline-info.btn-sm}
[Helmfile](#){:.btn.btn-outline-warning.btn-sm}
[OpenResty](#){:.btn.btn-outline-info.btn-sm}
[Prometheus](#){:.btn.btn-outline-success.btn-sm}
[Grafana](#){:.btn.btn-outline-info.btn-sm}
[Python](#){:.btn.btn-outline-info.btn-sm}
[GitHub Actions](#){:.btn.btn-outline-warning.btn-sm}
...
## 💬 Languages
---
[English](#){:.btn.btn-outline-success.btn-sm}
[Hindi](#){:.btn.btn-outline-success.btn-sm}

## 🐙 My Tools
---
[mCert](https://github.com/HarryTheDevOpsGuy/mCert){:.btn.btn-outline-success.btn-sm}
[mStatus](https://github.com/HarryTheDevOpsGuy/mStatus){:.btn.btn-outline-success.btn-sm}
[mSend](https://github.com/HarryTheDevOpsGuy/mSend){:.btn.btn-outline-success.btn-sm}
[mLog](https://github.com/HarryTheDevOpsGuy/mLog){:.btn.btn-outline-success.btn-sm}
[mTracker](https://github.com/HarryTheDevOpsGuy/mTracker){:.btn.btn-outline-success.btn-sm}
[mWatcher](https://github.com/HarryTheDevOpsGuy/mWatcher){:.btn.btn-outline-success.btn-sm}
...
<div class="d-print-none text-center" markdown="1">
